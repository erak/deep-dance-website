...
scrollCounter++;});$(document).ready(function(){resizeOverlay();preload();});$(window).resize(function(){resizeOverlay();});$('#mc_embed_signup .email').click(function(){$('#mc_embed_signup .email').css('background-color','white');});$('#overlay').click(function(){$('#mc_embed_signup .email').css('background-color','transparent');});;(function(){'use strict';if(!document.queryCommandSupported('copy')){return;}
