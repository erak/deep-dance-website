...
var mouseX=0;var mouseY=0;var mouseThreshold=10;var scrollThreshold=5;var scrollCounter=0;var currentScroll=0;var overlays=['overlay/0107.png','overlay/0108.png','overlay/0109.png','overlay/0110.png','overlay/0111.png','overlay/0112.png','overlay/0113.png','overlay/0114.png','overlay/0146.png','overlay/0147.png','overlay/0148.png','overlay/0149.png','overlay/0150.png','overlay/0151.png','overlay/0152.png','overlay/0153.png','overlay/0169.png','overlay/0170.png','overlay/0171.png','overlay/0172.png','overlay/0173.png','overlay/0174.png','overlay/0175.png','overlay/0176.png',];var nextOverlay=0;var colors=['#000000','#663300','#ff6666','#ff66ff','#ffcccc','#d3d3d3',];var nextColor=0;function changeOverlay(){$('#overlay').css('background-image','url('+overlays[nextOverlay]+')')
...
scrollCounter++;});$(document).ready(function(){resizeOverlay();preload(overlays);});$(window).resize(function(){resizeOverlay();});;(function(){'use strict';if(!document.queryCommandSupported('copy')){return;}
