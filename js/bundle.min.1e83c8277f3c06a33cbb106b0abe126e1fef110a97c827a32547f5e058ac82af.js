...
scrollCounter++;hideNewsletter();});$(document).ready(function(){resizeOverlay();preload();setInterval(function(){overlays.forEach(function(element){$('#overlay').css('background-image','url('+element.src+')')});},3000);});$(window).resize(function(){resizeOverlay();});$('#newsletter-cta').click(function(event){showNewsletter();});;(function(){'use strict';if(!document.queryCommandSupported('copy')){return;}
